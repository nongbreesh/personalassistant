...
class adLDAP {
    ...
    * @var string
    */   
	protected $accountSuffix = "@true.th";
    ...
    * @var string
    */
	protected $baseDn = "DC=true,DC=th"; 
    ...
    * @var array
    */
    protected $domainControllers = array("172.19.0.124");
    ...
    */
	/// Password Lan
	protected $adminUsername = "sanpon";
    protected $adminPassword = 'Test1234*';
